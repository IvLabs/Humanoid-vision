...
if("FALSE" STREQUAL "TRUE")
  set(uvc_camera_SOURCE_PREFIX /tmp/binarydeb/ros-indigo-uvc-camera-0.2.4)
  set(uvc_camera_DEVEL_PREFIX /tmp/binarydeb/ros-indigo-uvc-camera-0.2.4/obj-x86_64-linux-gnu/devel)
  ...
  set(uvc_camera_INSTALL_PREFIX /opt/ros/indigo)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'uvc_camera' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/opt/ros/indigo/${idir}'.  Ask the maintainer 'Ken Tossell <ken@tossell.net>' to fix it.")
    endif()
