...
static const char WINDOW[] = "published processed image";
...
void imageCallback(const sensor_msgs::ImageConstPtr& original_image)
{
    ...
    catch (cv_bridge::Exception& e)
    {
     ...
     cv::imshow("suscribed image from camera",cv_ptr->image);
   // create cicle on image
...
ROS_INFO("I published:processed image: red circle at top left");
...
int main(int argc, char **argv)
{
    ...
    */
    ...
    ROS_INFO("tutorial_ros_opencv::main.cpp::No error.");
