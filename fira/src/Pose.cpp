...
Pose::Pose()
	...
	cameraIntrinsicParams.at<float>(0,0)= 727.957294 ;
	cameraIntrinsicParams.at<float>(0,1)= 0.000000 ;
	cameraIntrinsicParams.at<float>(0,2)= 304.729528 ;
	cameraIntrinsicParams.at<float>(1,0)= 0.000000 ;
	cameraIntrinsicParams.at<float>(1,1)= 726.232798 ;
	cameraIntrinsicParams.at<float>(1,2)= 235.217420 ;
	cameraIntrinsicParams.at<float>(2,0)= 0.000000 ;
	cameraIntrinsicParams.at<float>(2,1)= 0.000000 ;
	cameraIntrinsicParams.at<float>(2,2)= 1.000000 ;
	
   
        distCoeffs=Mat(Size(5,1),CV_32F);
/*       	

	distCoeffs(0,0)= 0.064654f;
  	distCoeffs(0,1)=-0.451790f;
  	distCoeffs(0,2)= 0.002167f;
  	distCoeffs(0,3)= 0.000511f;
  	distCoeffs(0,4)= 0.000000f;
*/
    	distCoeffs.at<float>(0,0) = 0.;
	distCoeffs.at<float>(0,1) = 0.;
	distCoeffs.at<float>(0,2) = 0.;
	distCoeffs.at<float>(0,3) = 0.0;
...
cout<< ""<<contours0.size(); // Find the contours in the image
